package com.quantum.document.controllers;
...
import com.quantum.document.repos.DocumentRepository;
...
public class DocumentController {
	...
	public StreamingResponseBody download(@RequestParam("id") long id, HttpServletResponse response) {
		Optional<Document> docObj = repository.findById(id);
		Document document = docObj.get();
